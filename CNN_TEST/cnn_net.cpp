...
// ********************backward********************//
    ...
    // function_display(4,frame_c4_out,"g_frame_4_back:");
    ...
    // layer_maxpooling_c3[0].display();
    // function_display(8,layer_maxpooling_c3[0].layer_g_frame_output(),"g_fra_in:");
    // layer_cnn_c2[0].display();
    for(int j = 0 ; j < layer_c2_num ; j++)
    {
...
fid_frame_test_in.open("test_image_1.txt");
fid_answer_test_in.open("test_lable_1.txt");
double sum = 0;
